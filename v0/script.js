...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll(
        '.problem-card, .solution-card, .advantage-card, .featured-service-card, .secondary-service-item, .process-step, .proof-card, .featured-service-image, .solution-photo, .expert-photo'
    );
